...
namespace OOPDiar
{
    class Diar
    {
        ...
        {
            Console.WriteLine("Zadejte datum a čas ve tvaru [1.1.2021 14:00]:");
            DateTime datumCas;
        ...
        {
            Console.WriteLine("Budou vymyzány záznamy v daný den a hodinu");
            DateTime datumCas = ZjistiDatumCas();
        ...
        {
            Console.Clear();
            Console.WriteLine("Vítej v diáři!");
            Console.WriteLine();
            //Výpis hlavní obrazovky
            Console.WriteLine("Dneska:\n-----");
